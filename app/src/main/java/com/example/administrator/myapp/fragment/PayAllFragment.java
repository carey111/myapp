 ...
 */
public class PayAllFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.all_pay, null);
    ...
    public void onResume() {
        super.onResume();
        Log.e("posiotion", "onSuccess:2 "+"");
    }

    @Override
    public void initData() {

        Log.e("posiotion", "onSuccess:1 "+"payall");
